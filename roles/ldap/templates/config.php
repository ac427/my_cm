...
$config->custom->session['blowfish'] = '1fbbb27c3caa4f1bab6cc1c42d81d948';  # Autogenerated for master.home
...
$servers->setValue('login','bind_id','cn=admin,dc=home,dc=com');
...
#$servers->setValue('server','name','master');
$servers->setValue('server','host','192.168.1.10');
$servers->setValue('server','port',389);
$servers->setValue('server','base',array(''));
