...
# 
"""
Script to find rogue process on compute nodes which bypassed LSF scheduler
"""
...
process_cmd=["ps -ef | awk 'NR>1' | egrep -v \"68|"+users+" \"| awk '{print $3}' | sort -u" ]
